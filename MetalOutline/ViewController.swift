...
//        teapotNode.geometry?.firstMaterial?.lightingModel = .phong
        ...
        outlineProgram.vertexFunctionName = "lightingVertex"
        outlineProgram.fragmentFunctionName = "lightingFragment"
        teapotNode.geometry?.firstMaterial?.program = outlineProgram
    }
}
